...
<link rel="stylesheet" type="text/css" href="<?php echo $page["rootPath"]; ?>styles/portals/goods-adder.css">
 ...
 <script src="<?php echo $page["rootPath"]; ?>scripts/js/portals/goods-adder.js"></script>
 
 <div id="goodsAdderPortal" class="portal">
 	
 	<div id="head">
 	
 		<label id="heading">Add goods</label>
 	...
 	<div id="container">
 		...
 		<button id="btnAddGood" class="submitButton">Add good</button>
