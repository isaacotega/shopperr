<?php
	...
	($mailType == "passwordRecovery") or die(relocate("../../"));
...
<div id="main">
	...
	<p class="statement">We sent a mail to your email address, <b><?php echo $receiversMail; ?></b> to help you reset your password. Please reset your password by clicking on the link sent to your mail.</p>
